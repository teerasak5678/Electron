...
void setup() {
  ...
  client.connect("mqtt_bfish", "ppsmart", "ppmqtt");
  if (client.isConnected()) {
      client.publish("homeassistant/bfish","mqtt_bfish Connected.");
    }
...
void getGPS(){
  ...
  if (millis()-lastPublish > delayMinutes*60*1000) {
    ...
    if (t.gpsFix()) {
      ...
      Serial.println(t.readLatLon());
      client.publish("homeassistant/bfish/gps",String(t.readLatLon()));
...
void getTemp(){
  ...
  client.publish("homeassistant/bfish/ds18b20",String(celsius));
